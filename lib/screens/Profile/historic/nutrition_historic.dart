...
class NutritionHistory extends StatefulWidget {
  const NutritionHistory({super.key});

  @override
  State<NutritionHistory> createState() => _NutritionHistoryState();
}
...
class _NutritionHistoryState extends State<NutritionHistory> {
  @override
